...
UDreamUISpriteThumbnailRenderer::UDreamUISpriteThumbnailRenderer()
{

}
void UDreamUISpriteThumbnailRenderer::Draw(UObject* Object, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget* RenderTarget, FCanvas* Canvas, bool bAdditionalViewFamily)
{
	if (UDreamUISpriteData* sprite = Cast<UDreamUISpriteData>(Object))
	{
		DrawFrame(sprite, X, Y, Width, Height, RenderTarget, Canvas, nullptr);
	}
	
}
void UDreamUISpriteThumbnailRenderer::DrawFrame(class UDreamUISpriteData* Sprite, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget*, FCanvas* Canvas, FBoxSphereBounds* OverrideRenderBounds)
{
...
void UDreamUISpriteThumbnailRenderer::DrawGrid(int32 X, int32 Y, uint32 Width, uint32 Height, FCanvas* Canvas)
{
...
void UDreamUISpriteThumbnailRenderer::BeginDestroy()
{
	Super::BeginDestroy();
}