...
namespace DreamUIPrefabBehaviourUtilsTestLocal
{
	...
	struct FAutoBindFixture
	{
		...
		UDreamUIAutoBindTestBehaviour* Companion = nullptr;
		...
		FAutoBindFixture()
		{
			...
			Companion = Root->AddComponent<UDreamUIAutoBindTestBehaviour>();
		}
		~FAutoBindFixture()
		{
			if (World != nullptr)
		...
		void AddStandardChildren()
		{
			...
			AddChild(TEXT("Scoreboard"))->AddComponent<UDreamUIAutoBindTargetBehaviour>();
		}
	};
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindByDisplayNameTest,
	"DreamGUI.Prefab.Behaviour.AutoBindsWidgetAndBehaviourByDisplayName",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindByDisplayNameTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	...
	DreamUIPrefabBehaviourUtils::AutoBindAndValidate(Fixture.Root, Fixture.Prefab, BoundDetails, Problems, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindAmbiguousNameTest,
	"DreamGUI.Prefab.Behaviour.AmbiguousDisplayNameIsReportedNotGuessed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindAmbiguousNameTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindUnsavablePropertiesTest,
	"DreamGUI.Prefab.Behaviour.TransientAndUnrelatedPropertiesAreLeftAlone",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindUnsavablePropertiesTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindValidateOnlyTest,
	"DreamGUI.Prefab.Behaviour.ValidateOnlyReportsWithoutBinding",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindValidateOnlyTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
	...
	TArray<FString> BoundDetails, Problems;
	DreamUIPrefabBehaviourUtils::AutoBindAndValidate(Fixture.Root, Fixture.Prefab, BoundDetails, Problems, false);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindForeignReferenceTest,
	"DreamGUI.Prefab.Behaviour.ReferenceOutsidePrefabIsReported",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindForeignReferenceTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindBoundButUnsavableTest,
	"DreamGUI.Prefab.Behaviour.BoundNonInstanceEditablePropertyIsReported",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindBoundButUnsavableTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindAmbiguousCompanionTest,
	"DreamGUI.Prefab.Behaviour.AmbiguousCompanionBindsNothing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindAmbiguousCompanionTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
	...
	UDreamUIAutoBindTestBehaviour* Duplicate = Fixture.Root->AddComponent<UDreamUIAutoBindTestBehaviour>();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindSubPrefabWidgetTest,
	"DreamGUI.Prefab.Behaviour.SubPrefabWidgetIsReportedNotBound",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindSubPrefabWidgetTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabSystem;
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	Fixture.AddStandardChildren();
	UDreamWidget* NestedWidget = Fixture.AddChild(TEXT("InsideSubPrefab"));
	...
	UDreamUIPrefabHelperObject* Helper = Fixture.Prefab->GetPrefabHelperObject();
	...
	FDreamUISubPrefabData NestedData;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUIAutoBindExistingSubPrefabReferenceTest,
	"DreamGUI.Prefab.Behaviour.ExistingSubPrefabReferenceIsReported",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUIAutoBindExistingSubPrefabReferenceTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIPrefabSystem;
	using namespace DreamUIPrefabBehaviourUtilsTestLocal;
	FAutoBindFixture Fixture;
	...
	UDreamWidget* NestedWidget = Fixture.AddChild(TEXT("NestedOnly"));
