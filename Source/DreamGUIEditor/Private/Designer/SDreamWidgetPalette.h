 ...
 * exercised without one. What is left in SDreamWidgetPalette below is the wiring: collectors that
 ...
 */
class SDreamWidgetPalette : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SDreamWidgetPalette) {}
	SLATE_END_ARGS()

	virtual ~SDreamWidgetPalette() override;
