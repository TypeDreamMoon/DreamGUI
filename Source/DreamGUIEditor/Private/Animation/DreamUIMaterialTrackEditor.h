...
/**
 * A specialized material track editor for DreamGUI custom materials
 */
class FDreamUIMaterialTrackEditor
	: public FMaterialTrackEditor
{
public:

	FDreamUIMaterialTrackEditor( TSharedRef<ISequencer> InSequencer );
