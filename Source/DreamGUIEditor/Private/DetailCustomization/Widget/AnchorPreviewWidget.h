...
namespace DreamGUIAnchorPreviewWidget
{
	...
	public:
			...
			)
		{
			...
			auto anchorLineBrushHorizontal = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteDot");
			auto anchorLineBrushVertical = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteDot");
			...
			{
				anchorLineBrushHorizontal = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteFrame");
				anchorLineBrushVertical = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteFrame");
			}
			...
			{
				anchorLineBrushHorizontal = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteFrameHorizontal");
			...
			{
				anchorLineBrushVertical = FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteFrameVertical");
			...
			[
				...
				[
					...
					[
						...
						[
							SNew(SImage)
							.Image(FDreamGUIEditorStyle::Get().GetBrush("DreamGUIEditor.WhiteFrame"))
