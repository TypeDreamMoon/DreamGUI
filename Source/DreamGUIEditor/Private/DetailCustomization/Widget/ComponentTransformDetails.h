...
public:
	...
	FComponentTransformDetails( const TArray< TWeakObjectPtr<UDreamWidget> >& InSelectedObjects, const FSelectedActorInfo& InSelectedActorInfo, FNotifyHook* InNotifyHook );
...
private:
	...
	TArray< TWeakObjectPtr<UDreamWidget> > SelectedObjects;
	...
	friend struct FDreamTransformDetailsTestAccess;
#endif
};
