...
void FDreamWidgetBlueprintEditor::InitDesigner(const EToolkitMode::Type Mode, const TSharedPtr<IToolkitHost >& InitToolkitHost, UDreamWidgetBlueprint* InBlueprint)
{
	...
	TSharedPtr<FDreamWidgetBlueprintEditor> PrefabEditorPtr = SharedThis(this);

	ViewportPtr = SNew(SDreamUIPrefabEditorViewport, PrefabEditorPtr, BlueprintBeingEdited->DesignerData.ViewMode);
...
FDreamUIPrefabInstanceScene* FDreamWidgetBlueprintEditor::GetPreviewScene()
{ 
