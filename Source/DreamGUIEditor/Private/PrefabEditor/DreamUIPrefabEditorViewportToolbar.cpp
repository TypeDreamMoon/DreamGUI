...
void SDreamUIPrefabEditorViewportToolbar::Construct(const FArguments& InArgs, TSharedPtr<class ICommonEditorViewportToolbarInfoProvider> InInfoProvider)
{
	...
	TSharedRef<SDreamUIPrefabEditorViewport> DreamViewport = StaticCastSharedRef<SDreamUIPrefabEditorViewport>(ViewportRef);
	TWeakPtr<FDreamUIPrefabEditor> WeakEditor = DreamViewport->GetPrefabEditor();
	...
	TSharedRef<SWidget> ToolMenuWidget = UToolMenus::Get()->GenerateWidget(DreamUIViewportToolbarName, ViewportToolbarContext);
	...
	[
		...
		[
			...
			[
				...
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())return Editor->IsDesignerGridSnapEnabled() ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
					return ECheckBoxState::Unchecked;
				})
				.OnCheckStateChanged_Lambda([WeakEditor](ECheckBoxState)
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())Editor->ToggleDesignerGridSnap();
				})
				[
			...
			[
				...
				.IsChecked_Lambda([WeakEditor]()
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())return Editor->GetShowDesignerGuides() ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
					return ECheckBoxState::Unchecked;
				})
				.OnCheckStateChanged_Lambda([WeakEditor](ECheckBoxState)
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())Editor->ToggleDesignerGuides();
				})
				[
					SNew(SBox).WidthOverride(22).HeightOverride(22).HAlign(HAlign_Center).VAlign(VAlign_Center)
					[
			...
			[
				...
				.IsChecked_Lambda([WeakEditor]()
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())return Editor->GetShowLayoutDebug() ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
					return ECheckBoxState::Unchecked;
				})
				.OnCheckStateChanged_Lambda([WeakEditor](ECheckBoxState)
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())Editor->ToggleLayoutDebug();
				})
				[
					SNew(SBox).WidthOverride(22).HeightOverride(22).HAlign(HAlign_Center).VAlign(VAlign_Center)
					[
			...
			[
				...
				.IsChecked_Lambda([WeakEditor]()
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())return Editor->GetRespectDesignerLocks() ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
					return ECheckBoxState::Unchecked;
				})
				.OnCheckStateChanged_Lambda([WeakEditor](ECheckBoxState)
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())Editor->ToggleRespectDesignerLocks();
				})
				[
					SNew(SBox).WidthOverride(22).HeightOverride(22).HAlign(HAlign_Center).VAlign(VAlign_Center)
					[
			...
			[
				...
				.IsChecked_Lambda([WeakEditor]()
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())return Editor->GetShowDesignerChrome() ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
					return ECheckBoxState::Unchecked;
				})
				.OnCheckStateChanged_Lambda([WeakEditor](ECheckBoxState)
				{
					if (TSharedPtr<FDreamUIPrefabEditor> Editor = WeakEditor.Pin())Editor->ToggleShowDesignerChrome();
				})
				[
					SNew(SBox).WidthOverride(22).HeightOverride(22).HAlign(HAlign_Center).VAlign(VAlign_Center)
					[
