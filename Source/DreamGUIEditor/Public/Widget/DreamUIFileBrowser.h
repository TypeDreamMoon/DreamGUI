...
#define LOCTEXT_NAMESPACE "DreamGUIFileBrowser"

DECLARE_DELEGATE_OneParam(FOnStringChanged, const FString&);
/**
 * 
 */
class SDreamUIFileBrowser : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SDreamUIFileBrowser)
		...
		TSharedRef<SBox> MainContent =
			...
			[
				...
				[
					...
					.OnTextCommitted(this, &SDreamUIFileBrowser::OnPathTextCommited)
					.OnTextChanged(this, &SDreamUIFileBrowser::OnPathTextChanged)
				]
				+SOverlay::Slot()
				.HAlign(HAlign_Right)
				[
					...
					.OnClicked(this, &SDreamUIFileBrowser::OnBrowseButtonClicked, InArgs._DialogTitle, InArgs._FolderPath, InArgs._DefaultFileName, InArgs._Filter)
