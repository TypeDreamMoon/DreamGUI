 ...
 */
class DREAMGUI_API FDreamUIAuthoredGeometrySaveScope
{
public:
	explicit FDreamUIAuthoredGeometrySaveScope(UDreamWidget* RootWidget);
	~FDreamUIAuthoredGeometrySaveScope();

	FDreamUIAuthoredGeometrySaveScope(const FDreamUIAuthoredGeometrySaveScope&) = delete;
	FDreamUIAuthoredGeometrySaveScope& operator=(const FDreamUIAuthoredGeometrySaveScope&) = delete;
...
private:
	struct FEntry
	{
		...
		TWeakObjectPtr<UDreamPanelSlot> Slot;
		FDreamUIAnchorData LiveAnchorData;
