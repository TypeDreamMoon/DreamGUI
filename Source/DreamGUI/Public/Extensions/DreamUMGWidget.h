...
#include "DreamUMGWidget.generated.h"


/**
 * DreamUMGWidget can render a UMG widget as DreamUI's element, and interact with it by UIWidgetInteraction component.
 */
UCLASS(ClassGroup = (DreamGUI), NotBlueprintable, meta = (BlueprintSpawnableComponent))
class DREAMGUI_API UDreamUMGWidget : public UDreamCustomMesh
{
	GENERATED_BODY()
	
public:	
	UDreamUMGWidget(const FObjectInitializer& ObjectInitializer);
protected:
...
#endif
	TWeakObjectPtr<class UDreamTweener> Tweener = nullptr;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = DreamGUI, meta = (UnsafeDuringActorConstruction = true))
...
protected:
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = DreamGUI, meta = (ClampMin = "0.01"))
