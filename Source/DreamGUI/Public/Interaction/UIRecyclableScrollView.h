...
class DREAMGUI_API IUIRecyclableScrollViewCell
{
	GENERATED_BODY()
};
...
class DREAMGUI_API IUIRecyclableScrollViewDataSource
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "DreamGUI-RecyclableScrollView")
		int GetItemCount();
	/**
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "DreamGUI-RecyclableScrollView")
		void InitOnCreate(UDreamUIBehaviour* Component);
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "DreamGUI-RecyclableScrollView")
		void SetCell(UDreamUIBehaviour* Component, int Index);
...
public:
	UPROPERTY(EditAnywhere, Category = "DreamGUI")
		TObjectPtr<UDreamUIBehaviour> CellComponent = nullptr;
	UPROPERTY(EditAnywhere, Category = "DreamGUI")
...
class DREAMGUI_API UUIRecyclableScrollView : public UUIScrollViewWithScrollbar
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "DreamGUI-RecyclableScrollView", meta = (AllowedClasses = "/Script/DreamGUI.UIRecyclableScrollViewDataSource", DisplayThumbnail = "false"))
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = "DreamGUI-RecyclableScrollView")
		TObjectPtr<UDreamWidget> CellTemplate;
	/**
	...
	UPROPERTY(EditAnywhere, Category = "DreamGUI-RecyclableScrollView", meta = (ClampMin = "1", EditCondition = "Vertical"))
		uint16 Columns = 1;
	/**
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DreamGUI-RecyclableScrollView")
		void SetCellTemplate(UDreamWidget* value);
	/**
	 * CellTemplatePrefab's root actor must have a ActorComponent which implement UIRecyclableScrollViewCell interface.
	 * This function only set the parameter. If you want to refresh the display UI list, just call UpdateWithDataSource.
	 */
...
private:
	UPROPERTY(VisibleAnywhere, Transient, Category = "DreamGUI-RecyclableScrollView", AdvancedDisplay)
