...
namespace DreamPerspective
{
	 ...
	 */
	DREAMGUI_API FMatrix MakeRemap(const FScope& Scope, const FVector& OuterEye);
	 ...
	 */
	DREAMGUI_API FMatrix ComposeRemap(TArrayView<const FScope> ScopesInnermostFirst, const FVector& CanvasEye);
	 ...
	 */
	DREAMGUI_API bool ProjectOntoPlane(const FVector& Eye, const FVector& Point,
