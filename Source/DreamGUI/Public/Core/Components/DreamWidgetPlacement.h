...
#include "DreamWidgetPlacement.generated.h"
...
public:
	 ...
	 */
	bool Restore(UDreamWidget* InWidget) const;
...
private:
	UPROPERTY()
	TWeakObjectPtr<UDreamWidget> Parent = nullptr;
	UPROPERTY()
	...
	UPROPERTY()
	EDreamPanelHorizontalAlignment SlotHorizontalAlignment = EDreamPanelHorizontalAlignment::Fill;
	UPROPERTY()
	EDreamPanelVerticalAlignment SlotVerticalAlignment = EDreamPanelVerticalAlignment::Fill;
	UPROPERTY()
	EDreamPanelSizeRule SlotSizeRule = EDreamPanelSizeRule::Auto;
	UPROPERTY()
