 ...
 */
class DREAMGUI_API FDreamWidgetPreviewScene : public FGCObject
{
public:
	...
	FDreamWidgetPreviewScene(ConstructionValues CVS = ConstructionValues());
	virtual ~FDreamWidgetPreviewScene();
