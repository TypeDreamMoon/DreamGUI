...
{
	FDreamUIDuplicateOverrideParameterObjectWriter::FDreamUIDuplicateOverrideParameterObjectWriter(TArray< uint8 >& Bytes, WidgetSerializerBase& InSerializer, const TArray<FName>& InOverridePropertyNames)
		: FDreamUIOverrideParameterObjectWriter(Bytes, InSerializer, InOverridePropertyNames)
	{
		
	}
	bool FDreamUIDuplicateOverrideParameterObjectWriter::ShouldSkipProperty(const FProperty* InProperty) const
	{
	...
	bool FDreamUIDuplicateOverrideParameterObjectWriter::SerializeObject(UObject* Object)
	{
		if (Object->IsAsset())
		{
	...
	FString FDreamUIDuplicateOverrideParameterObjectWriter::GetArchiveName() const
	{
		return TEXT("FDreamUIDuplicateOverrideParameterObjectWriter");
	}



	FDreamUIDuplicateOverrideParameterObjectReader::FDreamUIDuplicateOverrideParameterObjectReader(TArray< uint8 >& Bytes, WidgetSerializerBase& InSerializer, const TArray<FName>& InOverridePropertyNames)
		: FDreamUIOverrideParameterObjectReader(Bytes, InSerializer, InOverridePropertyNames)
	{

	}
	bool FDreamUIDuplicateOverrideParameterObjectReader::ShouldSkipProperty(const FProperty* InProperty) const
	{
		if (InProperty->HasAnyPropertyFlags(CPF_Transient | CPF_DuplicateTransient | CPF_NonPIEDuplicateTransient | CPF_DisableEditOnInstance)
			|| InProperty->IsA<FMulticastDelegateProperty>()
			|| InProperty->IsA<FDelegateProperty>()
	...
	bool FDreamUIDuplicateOverrideParameterObjectReader::SerializeObject(UObject*& Object, bool CanSerializeClass)
	{
		uint8 typeUint8 = 0;
		*this << typeUint8;
	...
	FString FDreamUIDuplicateOverrideParameterObjectReader::GetArchiveName() const
	{
		return TEXT("FDreamUIDuplicateOverrideParameterObjectReader");
	}
}
