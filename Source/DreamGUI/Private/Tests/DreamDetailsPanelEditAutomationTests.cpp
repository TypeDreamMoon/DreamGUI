...
namespace DreamDetailsEditTestLocal
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamRenderTransformDetailsEditTest,
	"DreamGUI.Widget.DetailsEdit.RenderTransformTakesEffectFromThePanel",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamRenderTransformDetailsEditTest::RunTest(const FString& Parameters)
{
	using namespace DreamDetailsEditTestLocal;
	FScopedGameWorld TestWorld;
	UDreamWidget* Root = MakeWidget(TestWorld.World, nullptr, TEXT("Root"), 800.0f, 600.0f);
	UDreamWidget* Widget = MakeWidget(TestWorld.World, Root, TEXT("Widget"), 100.0f, 100.0f);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectiveDetailsEditTest,
	"DreamGUI.Widget.DetailsEdit.PerspectiveTakesEffectFromThePanel",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectiveDetailsEditTest::RunTest(const FString& Parameters)
{
	using namespace DreamDetailsEditTestLocal;
	FScopedGameWorld TestWorld;
	UDreamWidget* Root = MakeWidget(TestWorld.World, nullptr, TEXT("Root"), 800.0f, 600.0f);
