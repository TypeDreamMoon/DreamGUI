...
namespace DreamPerspectiveTestLocal
{
	using namespace DreamPerspective;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectiveReproducesTheInnerViewTest,
	"DreamGUI.Perspective.Math.TheOuterEyeSeesWhatTheInnerEyeWouldHave",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectiveReproducesTheInnerViewTest::RunTest(const FString& Parameters)
{
	using namespace DreamPerspectiveTestLocal;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectivePlaneIsFixedTest,
	"DreamGUI.Perspective.Math.ThePlaneItselfDoesNotMove",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectivePlaneIsFixedTest::RunTest(const FString& Parameters)
{
	using namespace DreamPerspectiveTestLocal;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectiveNestingTest,
	"DreamGUI.Perspective.Math.NestedScopesHandOffToEachOther",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectiveNestingTest::RunTest(const FString& Parameters)
{
	using namespace DreamPerspectiveTestLocal;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectiveDegenerateTest,
	"DreamGUI.Perspective.Math.DegenerateScopesAreIdentityNotGarbage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectiveDegenerateTest::RunTest(const FString& Parameters)
{
	using namespace DreamPerspectiveTestLocal;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamPerspectiveInvertibleTest,
	"DreamGUI.Perspective.Math.TheMapInvertsSoClicksCanBeTracedBack",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamPerspectiveInvertibleTest::RunTest(const FString& Parameters)
{
	using namespace DreamPerspectiveTestLocal;
