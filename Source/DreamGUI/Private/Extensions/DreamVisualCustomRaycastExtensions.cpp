...
bool UUIRenderableCustomRaycast_Circle::Raycast(UUIBaseRenderable* InUIRenderable, const FVector& InLocalSpaceRayStart, const FVector& InLocalSpaceRayEnd, FVector& OutHitPoint, FVector& OutHitNormal)
{
	...
	UE_LOG(DreamGUI, Error, TEXT("HitPointRelativeToCenter:%s, Angle:%f, AngleLerpValue:%f, MaxHitPoint:%s"), *HitPointRelativeToCenter.ToString(), FMath::RadiansToDegrees(AngleInRadias), RadiusLerpValue, *(MaxPoint.ToString()));
