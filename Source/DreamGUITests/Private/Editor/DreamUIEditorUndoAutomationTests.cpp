...
namespace DreamUIEditorUndoTestLocal
{
	 ...
	 */
	int32 ChildSlotCount(const UDreamWidget* Widget)
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamCreateWidgetIsUndoableTest,
	"DreamGUI.Editor.Undo.CreatingAWidgetIsRecorded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamCreateWidgetIsUndoableTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamUndoRestoresTheParentTest,
	"DreamGUI.Editor.Undo.UndoDoesNotReachPastTheCreate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamUndoRestoresTheParentTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIEditorUndoTestLocal;
	if (GEditor == nullptr || GEditor->Trans == nullptr)
	{
	...
	FDreamUIEditorTools::CreateWidgetAndReturn([Root]() { return Root; }, TEXT("Child"), nullptr, nullptr);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDreamCreateControlIsUndoableTest,
	"DreamGUI.Editor.Undo.CreatingARegisteredControlIsRecorded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDreamCreateControlIsUndoableTest::RunTest(const FString& Parameters)
{
	using namespace DreamUIEditorUndoTestLocal;
	if (GEditor == nullptr || GEditor->Trans == nullptr)
	{
	...
	UDreamWidget* Created = FDreamUIEditorTools::CreateRegisteredControlAndReturn([Root]() { return Root; }, TEXT("VerticalBox"), nullptr);
