...
#include "DreamLayoutInvalidationTestTypes.generated.h"
...
class UDreamApplyCountingAspectRatio : public UDreamLayoutSelfAspectRatio
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(NotBlueprintable, NotBlueprintType, Transient, HideDropdown)
class UDreamArrangeObservingOverlay : public UDreamLayoutContainerOverlay
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(NotBlueprintable, NotBlueprintType, Transient, HideDropdown)
class UDreamLayoutVisibilityFlipOverlay : public UDreamLayoutContainerOverlay
{
	GENERATED_BODY()
public:
	UPROPERTY(Transient)
	TObjectPtr<UDreamWidget> WidgetToReveal;
 ...
 */
UCLASS(NotBlueprintable, NotBlueprintType, Transient, HideDropdown)
class UDreamLayoutPassCountingOverlay : public UDreamLayoutContainerOverlay
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(NotBlueprintable, NotBlueprintType, Transient, HideDropdown)
class UDreamLayoutReentrantRebuildOverlay : public UDreamLayoutContainerOverlay
{
	GENERATED_BODY()
public:
	UPROPERTY(Transient)
	TArray<TObjectPtr<UDreamWidget>> RootsToRebuild;
