...
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerEnter(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerEnterCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerExit(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerExitCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerDown(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerDownCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerUp(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerUpCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerClick(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerClickCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerBeginDrag(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerBeginDragCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerDrag(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerDragCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerEndDrag(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerEndDragCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerDragDrop(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerDragDropCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerScroll(const TFunction<void(ULexPointerEventData*)>& InFunction)
{
	return OnPointerScrollCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerSelect(const TFunction<void(ULexBaseEventData*)>& InFunction)
{
	return OnPointerSelectCPP.AddLambda(InFunction);
}
FDelegateHandle UUIEventTriggerComponent::RegisterOnPointerDeselect(const TFunction<void(ULexBaseEventData*)>& InFunction)
{
...
{
	auto delegateHandle = OnPointerEnterCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
...
{
	auto delegateHandle = OnPointerExitCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerDownCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerUpCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerClickCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerBeginDragCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerDragCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerEndDragCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerDragDropCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerScrollCPP.AddLambda([InDelegate](ULexPointerEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerSelectCPP.AddLambda([InDelegate](ULexBaseEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
...
{
	auto delegateHandle = OnPointerDeselectCPP.AddLambda([InDelegate](ULexBaseEventData* eventData) {InDelegate.ExecuteIfBound(eventData); });
	return FLGUIDelegateHandleWrapper(delegateHandle);
}
