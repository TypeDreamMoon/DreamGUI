...
namespace LexCanvasScalerTestLocal
{
	struct FScopedCanvas
	{
		UWorld* World = nullptr;
		ULexWidget* Root = nullptr;
		ULexCanvas* Canvas = nullptr;
		...
		FScopedCanvas()
		{
			...
			Canvas = Root->AddComponent<ULexCanvas>();
		}
		~FScopedCanvas()
		{
			if (World != nullptr)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerConstantPixelSizeTest,
	"LGUI.Canvas.Scaler.ConstantPixelSizeMatchesViewport",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerConstantPixelSizeTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ConstantPixelSize);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerMatchWidthTest,
	"LGUI.Canvas.Scaler.MatchWidthKeepsReferenceWidth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerMatchWidthTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerMatchHeightTest,
	"LGUI.Canvas.Scaler.MatchHeightKeepsReferenceHeight",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerMatchHeightTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ScaleWithScreenSize);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerMatchBlendTest,
	"LGUI.Canvas.Scaler.MatchBlendsLinearlyBetweenWidthAndHeight",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerMatchBlendTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ScaleWithScreenSize);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerExpandShrinkTest,
	"LGUI.Canvas.Scaler.ExpandAndShrinkPickOppositeAxes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerExpandShrinkTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ScaleWithScreenSize);
	...
	Fixture.Canvas->SetScreenMatchMode(ELexCanvasScreenMatchMode::Expand);
	Fixture.Canvas->CalculateCanvasSizeAndScale(FIntPoint(2560, 1080), ExpandSize, ExpandScale);
	Fixture.Canvas->SetScreenMatchMode(ELexCanvasScreenMatchMode::Shrink);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerAspectPreservedTest,
	"LGUI.Canvas.Scaler.EveryModePreservesViewportAspect",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerAspectPreservedTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetReferenceResolution(FVector2D(1280, 720));
	...
	const ELexCanvasScreenMatchMode MatchModes[] = {
		ELexCanvasScreenMatchMode::MatchWidthOrHeight,
		ELexCanvasScreenMatchMode::Expand,
		ELexCanvasScreenMatchMode::Shrink,
	};
	for (ELexCanvasScreenMatchMode MatchMode : MatchModes)
	{
		Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ScaleWithScreenSize);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerDegenerateViewportTest,
	"LGUI.Canvas.Scaler.DegenerateViewportFallsBackToUnitScale",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerDegenerateViewportTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::ScaleWithScreenSize);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexCanvasScalerCustomFallbackTest,
	"LGUI.Canvas.Scaler.CustomWithoutHandlerFallsBackToConstantPixel",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexCanvasScalerCustomFallbackTest::RunTest(const FString& Parameters)
{
	using namespace LexCanvasScalerTestLocal;
	FScopedCanvas Fixture;
	Fixture.Canvas->SetScaleMode(ELexCanvasScaleMode::Custom);
	Fixture.Canvas->SetReferenceResolution(FVector2D(1280, 720));
