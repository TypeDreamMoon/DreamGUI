...
namespace LexCanvasViewFit
{
	 ...
	 */
	LGUI_API bool BuildClipCorrection(
	 ...
	 */
	LGUI_API bool IsCanvasViewUsable(double InEyeToPlaneDistance, double InNearClipPlane, double InFarClipPlane);
}
