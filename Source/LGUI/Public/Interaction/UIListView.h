...
class LGUI_API UUIListEntry : public ULexUIBehaviour, public IUIRecyclableScrollViewCell, public ILexPointerClickInterface
{
	GENERATED_BODY()
...
UCLASS(ClassGroup = (LGUI), Blueprintable, meta = (BlueprintSpawnableComponent))
class LGUI_API UUIListView : public UUIRecyclableScrollView, public IUIRecyclableScrollViewDataSource
{
	GENERATED_BODY()
...
protected:
	...
	virtual void InitOnCreate_Implementation(ULexUIBehaviour* Component) override;
	virtual void BeforeSetCell_Implementation() override;
	virtual void SetCell_Implementation(ULexUIBehaviour* Component, int Index) override;
	virtual void AfterSetCell_Implementation() override;
	virtual int32 GetEntryDepth(int32 Index) const { return 0; }
	UUIListEntry* ResolveEntry(ULexUIBehaviour* Component) const;
...
UCLASS(ClassGroup = (LGUI), Blueprintable, meta = (BlueprintSpawnableComponent))
class LGUI_API UUITileView : public UUIListView
{
	GENERATED_BODY()
protected:
...
class LGUI_API UUITreeViewItem : public UInterface
{
	GENERATED_BODY()
};

class LGUI_API IUITreeViewItem
{
	GENERATED_BODY()
public:
...
UCLASS(ClassGroup = (LGUI), Blueprintable, meta = (BlueprintSpawnableComponent))
class LGUI_API UUITreeView : public UUIListView
{
	GENERATED_BODY()
