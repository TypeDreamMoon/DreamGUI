...
void FLGUIEditorModule::StartupModule()
{
	...
	//blueprint
	{
		...
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULexUIWorldSpaceRaycasterSource::StaticClass(), TEXT("ReceiveInit"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULexUIWorldSpaceRaycasterSource::StaticClass(), TEXT("ReceiveGenerateRay"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULexUIWorldSpaceRaycasterSource::StaticClass(), TEXT("ReceiveShouldStartDrag"));
		...
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULexVisualBatchMeshModifierBase::StaticClass(), TEXT("ReceiveModifyUIGeometry"));
	}
