 ...
 * exercised without one. What is left in SLexUIPrefabPalette below is the wiring: collectors that
...
private:
	using EItemKind = LexUIPalette::EItemKind;
	using FPaletteItem = LexUIPalette::FPaletteItem;
	using FItemPtr = LexUIPalette::FItemPtr;
	...
	/** Push expansion onto the tree after a rebuild; see LexUIPalette::ShouldExpandGroup. */
