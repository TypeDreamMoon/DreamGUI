...
struct FLexTransformDetailsTestAccess
{
...
namespace LexTransformDetailsTestLocal
{
	...
	ULexWidget* MakeWidget(UWorld* World, const TCHAR* Name)
	{
	...
	TSharedRef<FComponentTransformDetails> MakeDetails(ULexWidget* First, ULexWidget* Second)
	{
		...
		FLexTransformDetailsTestAccess::SetPreserveScaleRatio(*Details, false);
		return Details;
	}

	FVector EulerOf(const ULexWidget* Widget)
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexTransformDetailsScaleKeepsOtherAxesTest,
	"LGUI.Editor.TransformDetails.MultiSelectScaleKeepsEachWidgetsOtherAxes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexTransformDetailsScaleKeepsOtherAxesTest::RunTest(const FString& Parameters)
{
	using namespace LexTransformDetailsTestLocal;
	FScopedTestWorld TestWorld;

	ULexWidget* First = MakeWidget(TestWorld.World, TEXT("First"));
	ULexWidget* Second = MakeWidget(TestWorld.World, TEXT("Second"));
	...
	FLexTransformDetailsTestAccess::SetTransform(*Details, ETransformField::Scale, EAxisList::X, FVector(3.0, 1.0, 1.0));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexTransformDetailsLocationKeepsOtherAxesTest,
	"LGUI.Editor.TransformDetails.MultiSelectLocationKeepsEachWidgetsOtherAxes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexTransformDetailsLocationKeepsOtherAxesTest::RunTest(const FString& Parameters)
{
	using namespace LexTransformDetailsTestLocal;
	FScopedTestWorld TestWorld;
	...
	FLexTransformDetailsTestAccess::SetTransform(*Details, ETransformField::Location, EAxisList::Y, FVector(0.0, 10.0, 0.0));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexTransformDetailsRotationKeepsOtherAxesTest,
	"LGUI.Editor.TransformDetails.MultiSelectRotationKeepsEachWidgetsOtherAxes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexTransformDetailsRotationKeepsOtherAxesTest::RunTest(const FString& Parameters)
{
	using namespace LexTransformDetailsTestLocal;
	FScopedTestWorld TestWorld;
	...
	FLexTransformDetailsTestAccess::SetTransform(*Details, ETransformField::Rotation, EAxisList::X, FVector(30.0, 0.0, 0.0));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexTransformDetailsAllAxesStillWritesWholeVectorTest,
	"LGUI.Editor.TransformDetails.PasteAndResetStillWriteEveryAxis",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexTransformDetailsAllAxesStillWritesWholeVectorTest::RunTest(const FString& Parameters)
{
	using namespace LexTransformDetailsTestLocal;
	FScopedTestWorld TestWorld;
	...
	TestEqual(TEXT("unedited axes come from the old value"),
		FLexTransformDetailsTestAccess::FilterAxes(*Details, EAxisList::X, FVector(3.0, 1.0, 1.0), FVector(2.0, 2.0, 2.0)),
		FVector(3.0, 2.0, 2.0));
	TestEqual(TEXT("all axes edited means nothing is kept"),
		FLexTransformDetailsTestAccess::FilterAxes(*Details, EAxisList::All, FVector(5.0, 6.0, 7.0), FVector(2.0, 2.0, 2.0)),
		FVector(5.0, 6.0, 7.0));
	...
	FLexTransformDetailsTestAccess::SetTransform(*Details, ETransformField::Scale, EAxisList::All, FVector(5.0, 6.0, 7.0));
