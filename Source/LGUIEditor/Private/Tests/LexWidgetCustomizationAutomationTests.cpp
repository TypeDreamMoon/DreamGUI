...
namespace LexWidgetCustomizationTestLocal
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexWidgetPivotCompensatesEverySelectedWidgetTest,
	"LGUI.Editor.WidgetDetails.PivotKeepsEverySelectedWidgetInPlace",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexWidgetPivotCompensatesEverySelectedWidgetTest::RunTest(const FString& Parameters)
{
	using namespace LexWidgetCustomizationTestLocal;
	FScopedTestWorld TestWorld;

	ULexWidget* Root = MakeRoot(TestWorld.World);
	ULexWidget* First = MakeChild(Root, TEXT("First"), 200.0f, 100.0f);
	ULexWidget* Second = MakeChild(Root, TEXT("Second"), 300.0f, 150.0f);
	...
	FLexWidgetCustomization::CaptureAnchorOffsets(Selection, Captured);
	...
	FLexWidgetCustomization::RestoreAnchorOffsets(Selection, Captured);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FLexWidgetAnchorValueReadsStretchPerWidgetTest,
	"LGUI.Editor.WidgetDetails.AnchorValueAsksEachWidgetWhetherItIsStretched",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FLexWidgetAnchorValueReadsStretchPerWidgetTest::RunTest(const FString& Parameters)
{
	using namespace LexWidgetCustomizationTestLocal;
	FScopedTestWorld TestWorld;

	ULexWidget* Root = MakeRoot(TestWorld.World);
	ULexWidget* Stretched = MakeChild(Root, TEXT("Stretched"), 200.0f, 100.0f);
	ULexWidget* Fixed = MakeChild(Root, TEXT("Fixed"), 200.0f, 100.0f);
	...
	FLexWidgetCustomization::ApplyAnchorValueToWidgets(Selection, 25.0f, 0);
	...
	FLexWidgetCustomization::ApplyAnchorValueToWidgets(Selection, 60.0f, 2);
