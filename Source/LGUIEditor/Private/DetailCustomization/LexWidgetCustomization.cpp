...
void FLexWidgetCustomization::AddSlotProperty(IDetailLayoutBuilder& DetailBuilder)
{
	...
	//anchor, width, height
	{
		...
		auto MakeAnchorPreviewWidget = [=, this](LGUIAnchorPreviewWidget::UIAnchorHorizontalAlign HAlign, LGUIAnchorPreviewWidget::UIAnchorVerticalAlign VAlign) {
			return
				...
				.ButtonEnable(true)
				.OnAnchorChange(this, &FLexWidgetCustomization::OnSelectAnchor, DetailBuilderPoiter)
			;
		...
		(
			FExecuteAction::CreateSP(this, &FLexWidgetCustomization::OnPasteAnchor, &DetailBuilder),
...
void FLexWidgetCustomization::ApplyValueChanged(float Value, TSharedRef<IPropertyHandle> AnchorHandle, int AnchorValueIndex)
{
	...
	auto AnchorProperty = FindFProperty<FProperty>(ULexWidget::StaticClass(), GET_MEMBER_NAME_CHECKED(ULexWidget, AnchorData));
...
void FLexWidgetCustomization::OnSelectAnchor(LGUIAnchorPreviewWidget::UIAnchorHorizontalAlign HorizontalAlign, LGUIAnchorPreviewWidget::UIAnchorVerticalAlign VerticalAlign, IDetailLayoutBuilder* DetailBuilder)
{
	...
	for (auto& UIItem : TargetScriptArray)
	{
		...
		FLexUIUtils::NotifyPropertyChanged(UIItem.Get(), GET_MEMBER_NAME_CHECKED(ULexWidget, AnchorData));
	}
...
void FLexWidgetCustomization::ForceRefreshEditor(IDetailLayoutBuilder* DetailBuilder)
{
	if (DetailBuilder)
	{
...
bool FLexWidgetCustomization::GetIsAnchorsEnabled()const
{
...
bool FLexWidgetCustomization::GetLayoutControlHorizontalAnchor()const
{
	return GetLayoutControlAnchorValue().bCanControlHorizontalAnchor;
}
bool FLexWidgetCustomization::GetLayoutControlVerticalAnchor()const
{
