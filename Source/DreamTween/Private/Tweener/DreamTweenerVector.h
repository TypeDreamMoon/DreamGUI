...
#include "DreamTweenerVector.generated.h"

UCLASS(NotBlueprintType)
class DREAMTWEEN_API UDreamTweenerVector :public UDreamTweener
{
	GENERATED_BODY()
public:
	...
	FDreamTweenVectorGetterFunction getter;
	FDreamTweenVectorSetterFunction setter;

	FVector originStartValue;

	void SetInitialValue(const FDreamTweenVectorGetterFunction& newGetter, const FDreamTweenVectorSetterFunction& newSetter, const FVector& newEndValue, float newDuration)
	{
