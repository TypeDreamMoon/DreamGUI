...
#include "DreamTweenerDouble.generated.h"

UCLASS(NotBlueprintType)
class DREAMTWEEN_API UDreamTweenerDouble:public UDreamTweener
{
	GENERATED_BODY()
public:
	...
	FDreamTweenDoubleGetterFunction getter;
	FDreamTweenDoubleSetterFunction setter;

	double originStartValue;

	void SetInitialValue(const FDreamTweenDoubleGetterFunction& newGetter, const FDreamTweenDoubleSetterFunction& newSetter, const double& newEndValue, float newDuration)
	{
