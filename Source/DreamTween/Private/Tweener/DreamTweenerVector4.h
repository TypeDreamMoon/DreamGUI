...
#include "DreamTweenerVector4.generated.h"

UCLASS(NotBlueprintType)
class DREAMTWEEN_API UDreamTweenerVector4 :public UDreamTweener
{
	GENERATED_BODY()
public:
	...
	FDreamTweenVector4GetterFunction getter;
	FDreamTweenVector4SetterFunction setter;

	FVector4 originStartValue;

	void SetInitialValue(const FDreamTweenVector4GetterFunction& newGetter, const FDreamTweenVector4SetterFunction& newSetter, const FVector4& newEndValue, float newDuration)
	{
