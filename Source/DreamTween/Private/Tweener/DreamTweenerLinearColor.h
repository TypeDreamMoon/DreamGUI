...
#include "DreamTweenerLinearColor.generated.h"

UCLASS(NotBlueprintType)
class DREAMTWEEN_API UDreamTweenerLinearColor :public UDreamTweener
{
	GENERATED_BODY()
public:
	...
	FDreamTweenLinearColorGetterFunction getter;
	FDreamTweenLinearColorSetterFunction setter;

	FLinearColor originStartValue;

	void SetInitialValue(const FDreamTweenLinearColorGetterFunction& newGetter, const FDreamTweenLinearColorSetterFunction& newSetter, const FLinearColor& newEndValue, float newDuration)
	{
